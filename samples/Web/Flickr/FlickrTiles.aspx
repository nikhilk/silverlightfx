...
<head>
  <title>Flickr Tiles</title>
</head>
<body style="height: 100%; margin: 0;">
  <div style="height: 100%;">
    <object style="width: 100%; height: 100%" type="application/x-silverlight">
	    <param name="source" value="FlickrTiles.xap" />
	    <param name="initParams" value="ApiKey=<asp:Literal runat="server" Text="<%$ appSettings:flickrApiKey%>" />" />
